    ...
    def __init__(self, mapString):
        ...
        for y in range(0, self.height):
            ...
            for x in range(0, self.width):
                ...
                if mapChar == 'G':
                    goblin = Unit(x, y, self.elves)
                    self.units.append(goblin)
                    self.goblins.append(goblin)
                if mapChar == 'E':
                    elf = Unit(x, y, self.goblins)
...
test('examplecombatinput1.txt', 27730)
test('examplecombatinput2.txt', 36334)
test('examplecombatinput3.txt', 39514)
test('examplecombatinput4.txt', 27755)
test('examplecombatinput5.txt', 28944)
test('examplecombatinput6.txt', 18740)
