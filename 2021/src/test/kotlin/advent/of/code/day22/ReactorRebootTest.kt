...
import advent.of.code.day22.ReactorReboot.CubeRange
...
internal class ReactorRebootTest {
    ...
    private val testSubject = ReactorReboot()
    ...
    fun `test example input for part 1`() {
        ...
        val result = testSubject.countCubesThatAreOnAfterApplyingRebootSteps(exampleInput, filterBounds = true)

        assertThat(result).isEqualTo(590784)
    }
    ...
    fun `test example input for part 2`() {
        ...
        val result = testSubject.countCubesThatAreOnAfterApplyingRebootSteps(exampleInput, filterBounds = false)

        assertThat(result).isEqualTo(2758514936282235)
    }

    @Nested
    inner class TestCubeRange {
        @Test
