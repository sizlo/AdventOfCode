...
internal class BeaconScannerTest {
    ...
    private val testSubject = BeaconScanner(exampleInput)

    @Test
    fun `test example input for part 1`() {
        val result = testSubject.findTotalNumberOfBeacons()
    ...
    fun `test example input for part 2`() {
        val result = testSubject.findLargestManhattanDistanceBetweenAnyTwoScanners()
